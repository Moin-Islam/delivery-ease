...
const WholeProduct = ({
  ...
  let produc = `${baseUrl}/warehouse_current_stock_list`;
    ...
    await axios
      ...
      .then(
        axios.spread((...responses) => {
          ...
          setProducts(responsethree.data.response.warehouse_current_stock_list);
          setProds(responsethree.data.response.warehouse_current_stock_list);
          setLoad(true);
        })
      )
      .catch((errors) => {
                  ...
                  <CardActionArea onClick={() => getProduct(prod)}>
                    ...
                    <CardContent>
                      ...
                      <Typography
                        ...
                        component="p"
                      >
                        Current Stock :{prod.current_stock}
                      </Typography>
                      <Typography
                        variant="body2"
                        color="textSecondary"
