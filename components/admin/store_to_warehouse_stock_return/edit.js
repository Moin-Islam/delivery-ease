            ...
            <CardBody>
              <Formik
                ...
                validate={(values) => {
                  const errors = {};
                  if (!values.store_id) {
                    errors.values.store_id = "Required";
                  }
                    ...
                    axios
                      .post(
                        `${baseUrl}/${endpoint}`,
                        {
                          ...
                          return_from_store_id: values.store_id,
                          return_to_warehouse_id: values.warehouse_id,
                                          ...
                                          (product, index) => (
                                            <>
                                              <Field
                                                ...
                                                fullWidth
                                                type="text"
                                                label="store_stock_return_detail_id"
                                                hidden={true}
                                                name={`products.${index}.store_stock_return_detail_id`}
                                              />
                                              <Field
                                                variant="outlined"
                                                margin="normal"
