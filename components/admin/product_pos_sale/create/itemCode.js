    ...
    (() => {
      if (item == "") {
        ...
        axios
          .all([
            axios.post(
              `${baseUrl}/store_current_stock_list_pagination_item_code?page=1`,
              {
                store_id: store_id,
                item_code: item,
              },
              ...
              if (__FOUND.length == 0) {
                ...
                if (found == undefined) {
                  push({
                    ...
                    category_id: __FOUND[0].product_category_id,
                    product_category_name: __FOUND[0].product_category_name,
